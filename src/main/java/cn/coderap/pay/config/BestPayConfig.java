...
public class BestPayConfig {
    ...
    public BestPayService bestPayService(WxPayConfig wxPayConfig) {
        ...
        aliPayConfig.setNotifyUrl("http://3eiqu5.natappfree.cc/pay/notify");
    ...
    public WxPayConfig wxPayConfig() {
        ...
        wxPayConfig.setAppId("wxd898fcb01713c658"); //wx00d52d21505f383f
        wxPayConfig.setMchId("1483469312"); //1226270402
        wxPayConfig.setMchKey("7mdApPMfXddfWWbbP4DUaVYm2wjyh3v3"); //shengwei520soucang96567key1987sw
        //异步回调地址必须公网能够访问，且不能带参数
        wxPayConfig.setNotifyUrl("http://3eiqu5.natappfree.cc/pay/notify");
